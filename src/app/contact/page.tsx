...
export default function ContactPage() {
  ...
  return (
    <div style={{ minHeight: "100vh" }}>
      ...
      <Link
        href="/"
        className="hidden md:inline-flex fixed top-5 left-5 z-40 items-center gap-2 text-sm font-semibold text-gold-700 glass rounded-full px-4 py-2.5 transition-transform hover:-translate-x-0.5"
      >
        <ArrowLeft size={15} /> Back to Main Page
      </Link>
          ...
          {sent ? (
            ...
            <div className="grid gap-4">
              <div className="grid sm:grid-cols-2 gap-4">
                <input placeholder="Full name" className="px-4 py-3 rounded-xl border border-pearl-300 bg-white text-graphite-900 text-sm outline-none focus:border-gold-500" />
                <input type="tel" placeholder="Phone number" className="px-4 py-3 rounded-xl border border-pearl-300 bg-white text-graphite-900 text-sm outline-none focus:border-gold-500" />
              </div>
              <input type="email" placeholder="Email address" className="px-4 py-3 rounded-xl border border-pearl-300 bg-white text-graphite-900 text-sm outline-none focus:border-gold-500" />
              <textarea rows={4} placeholder="How can we help?" className="px-4 py-3 rounded-xl border border-pearl-300 bg-white text-graphite-900 text-sm outline-none focus:border-gold-500 resize-none" />
              <button
